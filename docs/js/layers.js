...
function makeTileGetter(uriBuilder, options) {
    var _a, _b;
    const maxRetries = (_a = options === null || options === void 0 ? void 0 : options.maxRetries) !== null && _a !== void 0 ? _a : DEFAULT_MAX_RETRIES;
    const retryBaseDelayMs = (_b = options === null || options === void 0 ? void 0 : options.retryBaseDelayMs) !== null && _b !== void 0 ? _b : DEFAULT_RETRY_BASE_DELAY_MS;
