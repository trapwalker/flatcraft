...
// TOUCH-1: the subset of a multi-touch gesture's geometry the touchmove handler needs from one
...
export class MapWidget { // todo: setup layers
  ...
  // TOUCH-1: canvas-local position of every currently active touch, keyed by
